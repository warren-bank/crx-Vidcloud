...
// @version      1.0.15
// @include      /^https?:\/\/(?:[^\.\/]*\.)*(?:vidcloud\.(?:uno)|vidclouds\.(?:us|icu)|vidcloud[0-9]+\.(?:com)|viddcloud\.(?:store)|vidembed\.(?:me|io|cc)|vidnext\.(?:net)|vidnode\.(?:net)|membed\.(?:net))\/.*$/
// @icon         https://viddcloud.store/favicon.ico
// @run-at       document-end
